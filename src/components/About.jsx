...
const About = () => {
  return (
    <>
      ...
      <div className="container mt-4 px-5 text-center text-lg-start">
        <div className="row">
          <div className="col-md-12 col-lg-6 p-lg-4">
            ...
            <p className="fw-semibold text-black">
              ...
              building fast, responsive, and visually appealing websites and web
              applications. With a solid foundation in HTML, CSS, JavaScript,
              and modern frameworks like React.js and Bootstrap, I create
              seamless user experiences that work across all devices.
            </p>
            <div className="shade">
          ...
          <div className="img-container d-none d-lg-block col-md-12 rounded-5 col-lg-5 p-0 shadow">
            <img
              className="img"
              src={Web}
